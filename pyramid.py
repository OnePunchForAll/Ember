...
SYNTHESES = (
    ...
    synthesis('four_face_orbit_question', 'APEX', ('orbit_prefix', 'orbit_law_transfer', 'orbit_kernel_separation',
              'orbit_drift_separation', 'apex_memory'), 'apex.solve_single',
    ...
    synthesis('reduced_generating_function', 'PROPOSED', ('generating_function_formation', 'generating_function_check'),
              'none', 'Cancel gcd(P,Q) to certify the least eventual recurrence, not only the all-index one.',
              needs=('polynomial_gcd_reduction', 'reduced_fraction_check'), node='NWS'),
)
